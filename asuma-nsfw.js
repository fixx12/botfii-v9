...
let handler = async (m, { Ditss, isCreator, isPremium, qtext, runtime, toIDR, qkontak, asumaSaldo, ditsganteng, pickRandom, readmore, prefix, fetchJson, salam}) => {
...
handler.command = ["nswfmenu", "menunsfw", "asuma-nsfw"]
