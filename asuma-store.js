...
let handler = async (m, { Ditss, isCreator, isPremium, qtext, runtime, toIDR, qkontak, asumaSaldo, ditsganteng, pickRandom, readmore, fetchJson }) => {

const asumaByDits = `*\`乂 STORE - M E N U 乂\`*
> ┌  ◦ *nokos* : ${ki}coming soon${ki} 
> └  ◦ *vps* : ${ki}coming soon${ki}
> ┌  ◦ *panel* : ${ki}coming soon${ki}
> └  ◦ *top-up* : ${ki}coming soon${ki}
> ┌  ◦ *pulsa* : ${ki}coming soon${ki}
> └  ◦ *sewa* : ${ki}coming soon${ki}
> ┌  ◦ *mc* : ${ki}coming soon${ki}
> └  ◦ *buypanel* : ${ki}coming soon${ki}`
...
Ditss.sendMessage(m?.chat, {
    ...
    fileName: `${global.namaOwner} marketplace`,
...
handler.command = ["menustore", "storemenu", "asuma-store"]
